...
- Read `bug-fix-handoff.md` at the repo root. It contains the authoritative **Checklist** of files to review (fixed order — do not recompute or reorder it), plus **Cross-file leads** and **Verified not bugs** sections.
...
- Find and run the project's test/verify command (check CLAUDE.md, package.json scripts, Makefile, CI config, README). It must pass in full after any change.
